...
function HomeHero() {
  return (
   <main className='flex justify-end items-center pr-10 lg:max-w-[1440px] h-[] max-h-screen bg-homeImg  md:bg-contain bg-repeat bg-center lg:bg-cover md:bg-bottom mx-auto'>
    <div className=' w-[643px] pb-10 bg-[#FFF3E3]  px-10 '>
